...
export default function AvisContent({ vendor, prestataireData, isValid }: AvisContentProps) {
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-8">
            <div className="text-center sm:text-left">
              ...
              <div className="mt-2 flex items-center justify-center gap-1 sm:justify-start">
                <StarRating rating={Math.round(vendor.rating)} readonly size="md" />
              </div>
            ...
            <div className="flex-1 text-center sm:text-left">
              <p className="text-sm text-ink-muted sm:text-base">
                Excellent travail ! Continuez à offrir un service de qualité pour
                maintenir cette note exceptionnelle.
              </p>
            </div>
          </div>
        </div>
